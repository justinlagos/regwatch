...
async function getData() {
  ...
  return { score, totalHigh, remediatedCount, controlStats, clauseGaps }
}
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">Internal policies, procedures, and control processes linked to signals</p>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        <div className="sm:col-span-1 bg-white rounded-xl border border-gray-200 p-6 shadow-sm flex flex-col items-center justify-center text-center">
          ...
          <p className="text-xs text-slate-400 mt-3">{remediatedCount} of {totalHigh} L3+L4 signals remediated</p>
        </div>
            ...
            <div className="space-y-2">
              {clauseGaps.slice(0,5).map(({ clause, total, addressed, gap }) => (
                <div key={clause} className="flex items-center gap-3">
                  ...
                  <span className="text-xs text-red-500 font-semibold w-16 text-right shrink-0">{gap} open</span>
                </div>
              ))}
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          <h2 className="font-semibold text-slate-800">Controls</h2>
